...
const HowItWorksEnhanced = () => {
  const t = {
    ...
    en: {
      title: "How Does Khadoom Work?",
      subtitle: "A simple and fast process in just 6 steps",
      ...
      clientSteps: [
        {
          icon: MessageCircle,
          title: "Start a Chat",
          description: "Send your request via WhatsApp with project details",
          badge: "Step 1",
          color: "text-blue-600",
          bgColor: "bg-blue-600/10",
        },
        {
          ...
          description: "AI searches for the best suitable freelancers",
          badge: "Step 2",
          color: "text-purple-600",
          bgColor: "bg-purple-600/10",
        },
        {
          ...
          description: "Review profiles and ratings, choose the best fit",
          badge: "Step 3",
          color: "text-emerald-600",
          bgColor: "bg-emerald-600/10",
        },
        {
          ...
          description: "Discuss details, deliverables, and price with freelancer",
          badge: "Step 4",
          color: "text-amber-600",
          bgColor: "bg-amber-600/10",
        },
        {
          ...
          description: "Pay securely, funds protected until work delivery",
          badge: "Step 5",
          color: "text-primary",
          bgColor: "bg-primary/10",
        },
        {
          icon: Star,
          title: "Rate & Review",
          description: "Receive work and rate freelancer to help others",
          badge: "Step 6",
          color: "text-orange-600",
          bgColor: "bg-orange-600/10",
        },
      ...
      freelancerSteps: [
        {
          icon: UserCheck,
          title: "Register Free",
          description: "Create your profile and add skills and past work",
          badge: "Step 1",
          color: "text-blue-600",
          bgColor: "bg-blue-600/10",
        },
        {
          ...
          description: "Get instant notifications for projects matching you",
          badge: "Step 2",
          color: "text-purple-600",
          bgColor: "bg-purple-600/10",
        },
        {
          ...
          description: "Send professional quote with samples of your work",
          badge: "Step 3",
          color: "text-emerald-600",
          bgColor: "bg-emerald-600/10",
        },
        {
          icon: Handshake,
          title: "Start Working",
          description: "After acceptance, start work as per agreement",
          badge: "Step 4",
          color: "text-amber-600",
          bgColor: "bg-amber-600/10",
        },
        {
          ...
          description: "After delivery and approval, get paid instantly",
          badge: "Step 5",
          color: "text-primary",
          bgColor: "bg-primary/10",
        },
        {
          ...
          description: "Get positive reviews and increase future opportunities",
          badge: "Step 6",
          color: "text-orange-600",
          bgColor: "bg-orange-600/10",
        },
