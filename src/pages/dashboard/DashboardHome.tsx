...
import { MessageCircle, Users, Briefcase, DollarSign, Star } from "lucide-react";
            ...
            <div className="relative z-10">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            <h1 className="text-3xl font-bold text-foreground accent-text">لوحة تحكم المستقل</h1>
